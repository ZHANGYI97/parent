...
public final class ArraysUtils {
    ...
    /** @deprecated */
    public static void fill(byte[] var0, int var1, byte var2) {
        fill(var0, var1, var0.length, var2);
    }
    ...
    /** @deprecated */
    public static void fill(int[] var0, int var1, int var2) {
        java.util.Arrays.fill(var0, var1, var0.length, var2);
    }
    ...
    /** @deprecated */
    public static void fill(long[] var0, int var1, long var2) {
        java.util.Arrays.fill(var0, var1, var0.length, var2);
    }
    ...
    /** @deprecated */
    public static void fill(short[] var0, int var1, short var2) {
        java.util.Arrays.fill(var0, var1, var0.length, var2);
    }
    ...
    public static byte[] concatenate(byte[] var0, byte[] var1, byte[] var2, byte[] var3) {
        if (null == var0) {
            ...
            int var6 = var5 + var0.length;
            System.arraycopy(var1, 0, var4, var6, var1.length);
            var6 += var1.length;
            System.arraycopy(var2, 0, var4, var6, var2.length);
            var6 += var2.length;
            System.arraycopy(var3, 0, var4, var6, var3.length);
            return var4;
        }
    }
